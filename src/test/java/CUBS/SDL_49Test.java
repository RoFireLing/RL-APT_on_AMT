...
public class SDL_49Test extends TestCase {
    ...
    @Test
    public void testSDL_49() {
        String mutantName = "SDL_49";
        ...
        for (TestCase4CUBS tc : testcases) {
            ...
            labprograms.CUBS.mutants.SDL_49.BillCalculation mutant = new labprograms.CUBS.mutants.SDL_49.BillCalculation();
