...
public class SDL_42Test extends TestCase {
    ...
    @Test
    public void testSDL_42() {
        String mutantName = "SDL_42";
        ...
        for (TestCase4MOS tc : testcases) {
            ...
            labprograms.MOS.mutants.SDL_42.MealOrderingSystem mutant = new labprograms.MOS.mutants.SDL_42.MealOrderingSystem();
