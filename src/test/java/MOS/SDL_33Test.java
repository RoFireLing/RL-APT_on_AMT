...
public class SDL_33Test extends TestCase {
    ...
    @Test
    public void testSDL_33() {
        String mutantName = "SDL_33";
        ...
        for (TestCase4MOS tc : testcases) {
            ...
            labprograms.MOS.mutants.SDL_33.MealOrderingSystem mutant = new labprograms.MOS.mutants.SDL_33.MealOrderingSystem();
