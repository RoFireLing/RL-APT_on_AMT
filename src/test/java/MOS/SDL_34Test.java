...
public class SDL_34Test extends TestCase {
    ...
    @Test
    public void testSDL_34() {
        String mutantName = "SDL_34";
        ...
        for (TestCase4MOS tc : testcases) {
            ...
            labprograms.MOS.mutants.SDL_34.MealOrderingSystem mutant = new labprograms.MOS.mutants.SDL_34.MealOrderingSystem();
