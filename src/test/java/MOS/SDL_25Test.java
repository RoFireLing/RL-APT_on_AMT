...
public class SDL_25Test extends TestCase {
    ...
    @Test
    public void testSDL_25() {
        String mutantName = "SDL_25";
        ...
        for (TestCase4MOS tc : testcases) {
            ...
            labprograms.MOS.mutants.SDL_25.MealOrderingSystem mutant = new labprograms.MOS.mutants.SDL_25.MealOrderingSystem();
