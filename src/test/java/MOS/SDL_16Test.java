...
public class SDL_16Test extends TestCase {
    ...
    @Test
    public void testSDL_16() {
        String mutantName = "SDL_16";
        ...
        for (TestCase4MOS tc : testcases) {
            ...
            labprograms.MOS.mutants.SDL_16.MealOrderingSystem mutant = new labprograms.MOS.mutants.SDL_16.MealOrderingSystem();
