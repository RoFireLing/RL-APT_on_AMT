...
public class SDL_24Test extends TestCase {
    ...
    @Test
    public void testSDL_24() {
        String mutantName = "SDL_24";
        ...
        for (TestCase4MOS tc : testcases) {
            ...
            labprograms.MOS.mutants.SDL_24.MealOrderingSystem mutant = new labprograms.MOS.mutants.SDL_24.MealOrderingSystem();
