...
import labprograms.newStrategy.utl.RLAPT_S;
...
public class RLAPT_rlapts implements NewStrategy {
    ...
    public void testing(String objectName, int repeatTimes) {
        ...
        for (int i = 0; i < Constant.repeatNumber; i++) {
            System.out.println("RL-APT4" + objectName + "使用rlapt_s:" +
            ...
            for (int j = 0; j < 10000; j++) {
                ...
                nextnextPartitionIndex = rlapt.nextPartition4RLAPT(objectName, nextPartitionIndex, counter);
...
//                            String resultRelation = GetResultRelation4MOS.getResultRelation(sourceResult,followUpResult);
                ...
                //根据测试结果调整测试剖面
                rlapt.adjustRLAPT_S(counter, partitionIndex, nextPartitionIndex, nextnextPartitionIndex, isKilledMutants);
            }
        ...
        //记录均值结果方便查看
        String txtLogName = "RLAPT_S4" + objectName + ".txt";
        ...
        txtLogName = "RLAPT_S4" + objectName + "_Contents.txt";
...
//
//        String excelLogName = "RLAPT_rlapts4" + objectName + ".xlsx";
