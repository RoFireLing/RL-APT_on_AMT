...
import labprograms.newStrategy.utl.RLAPT_RAPT;
...
public class RLAPT_rapt implements NewStrategy {
    ...
    public void testing(String objectName, int repeatTimes) {
        ...
        for (int i = 0; i < Constant.repeatNumber; i++) {
            System.out.println("RL-APT4" + objectName + "使用RAPT:" +
...
//                            String resultRelation = GetResultRelation4MOS.getResultRelation(sourceResult,followUpResult);
        ...
        //记录均值结果方便查看
        String txtLogName = "RAPT4" + objectName + ".txt";
        ...
        txtLogName = "RAPT4" + objectName + "_Contents.txt";
...
//
//        String excelLogName = "RLAPT_rapt4" + objectName + ".xlsx";
