...
/**
 * @Description: test case selection strategy : MAPT
 * MR selection strategy : random
 * @auther phantom
 * @create 2019-09-17 下午9:58
 */
public class AMTMAPTplusRandom implements NewStrategy {


    public static void main(String[] args) {
        AMTMAPTplusRandom mt = new AMTMAPTplusRandom();
        String[] names = {"CUBS"};
        for (int i = 0; i < 10; i++) {
    ...
    public void testing(String objectName, int repeatTimes) {
        ...
        for (int i = 0; i < Constant.repeatNumber; i++) {
            System.out.println("AMTMAPTplusRandom4" + objectName + "使用MAPT+RT:" +
        ...
        //记录均值结果方便查看
        String txtLogName = "AMTMAPTplusRandom" + objectName + ".txt";
        ...
        String excelLogName = "AMTMAPTplusRandom" + objectName + ".xlsx";
