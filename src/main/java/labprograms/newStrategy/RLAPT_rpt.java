...
import labprograms.newStrategy.utl.RLAPT_RPT;
 ...
 * @date 2020/12/24
 **/
public class RLAPT_rpt implements NewStrategy {
    public static void main(String[] args) {
        RLAPT_rpt rt = new RLAPT_rpt();
        String[] names = {"ACMS"};
        for (int i = 0; i < 50; i++) {
    ...
    public void testing(String objectName, int repeatTimes) {
        ...
        for (int i = 0; i < Constant.repeatNumber; i++) {
            System.out.println("RL-APT4" + objectName + "使用rpt:" +
            ...
            //初始化测试剖面
            rpt.initializeRPT(Constant.getPartitionNumber(objectName));
...
//                            String resultRelation = GetResultRelation4MOS.getResultRelation(sourceResult,followUpResult);
        ...
        //记录均值结果方便查看
        String txtLogName = "RPT4" + objectName + ".txt";
        ...
        txtLogName = "RPT4" + objectName + "_Contents.txt";
