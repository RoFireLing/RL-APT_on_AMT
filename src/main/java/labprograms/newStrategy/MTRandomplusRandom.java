...
import labprograms.newStrategy.utl.GetResultRelation4MOS;
 ...
 * @Description:
 * @auther phantom
 * @create 2019-09-16 下午8:53
 */
public class MTRandomplusRandom implements NewStrategy {

    public static void main(String[] args) {
        MTRandomplusRandom mt = new MTRandomplusRandom();
        String[] names = {"CUBS"};
        for (int i = 0; i < 200; i++) {
    ...
    public void testing(String objectName, int repeatTimes) {
        ...
        for (int i = 0; i < Constant.repeatNumber; i++) {
            System.out.println("MTRandomplusRandom" + "4" + objectName + ":" + "执行第" + String.valueOf(i + 1)
                    + "次测试：");
        ...
        //记录均值结果方便查看
        String txtLogName = "MTRandomplusRandom4" + objectName + ".txt";
        ...
        String excelLogName = "MTRandomplusRandom4" + objectName + ".xlsx";
